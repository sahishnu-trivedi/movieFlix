...
export default function Trending () {
    ...
    return(
        <div className='pb-4 mt-20'>
            <div className="trending-banner relative overflow-hidden bg-gray-900 py-16 sm:py-20 md:py-24 banner-overlay text-center">
                <h3 className='mb-4 lg:text-6xl text-4xl font-bold text-primary-color relative z-40'>Trending Now</h3>
            </div>
